                            ...
                            <div class="form-wrap mt-40">
                                ...
                                <div class="row">
                                    <div class="col-md-7 col-md-offset-3">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label mb-10 text-left">Product
                                                    Price</label>
                                                <div class="col-md-8">
                                                    <input type="number" class="form-control mb-10" name="product_price"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label mb-10 text-left">Product Image<span
                                                        class="help"> *</span></label>
                                                <div class="col-md-8">
                                                    <input type="file" class="form-control mb-10" name="product_image"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label mb-10 text-left">Tamil Product
                                        ...
                                        <div class="row">
                                            <div class="col-md-7 col-md-offset-3">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <label class="col-md-4 control-label mb-10  text-left">
                                                            </label>
                                                            <button class="btn  btn-primary btn-rounded"
                                                                type="submit">Save</button>
                                                            <a href="{{ url(ADMINURL . '/viewproduct') }}"
