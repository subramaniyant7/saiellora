                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap mt-40">
                                <form method="post" action="{{ url(ADMINURL . '/homepage_video') }}"
                                        ...
                                        <div class="col-md-7 col-md-offset-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label mb-10 text-left">Image<span
                                                            class="help"> *</span></label>
                                                    <div class="col-md-8">
                                                        <input type="file" class="form-control mb-10"
                                                            name="home_video_image"
                                                            {{ count($homeVideo) && $homeVideo[0]->home_video_image != '' ? '' : 'required' }}
                                                        ...
                                                        @if (count($homeVideo) && $homeVideo[0]->home_video_image != '')
                                                            <span><img style="height: 200px;margin-top: 1em;"
                                                                    src="{{ URL::asset('uploads/homepage/' . $homeVideo[0]->home_video_image) }}"></span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label mb-10 text-left">Title<span
                                                            class="help"> *</span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control mb-10"
                                                            name="home_video_title" required
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label mb-10 text-left">Video Link<span
                                                            class="help"> *</span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control mb-10"
                                                            name="home_video_link" required
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="selectpicker" name="status"
                                                            ...
                                                            @foreach (statustype() as $k => $statustype)
                                                                <option value="{{ $k + 1 }}"
                                                                    {{ count($homeVideo) && $homeVideo[0]->status == $k + 1 ? 'selected' : '' }}>
                                                                    {{ $statustype }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                            ...
                            <div class="form-wrap mt-40">
                                ...
                                <form method="post" action="{{ url(ADMINURL . '/homepage_tamilvideo') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-7 col-md-offset-3">
                                            <div class="col-md-12">
