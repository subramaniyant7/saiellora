                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap mt-40">
                                <form method="post" action="{{ url(ADMINURL.'/savecategorydetails') }}" enctype='multipart/form-data'>
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-7 col-md-offset-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control mb-10" name="category_name" required
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label mb-10 text-left">Category Image</label>
                                                    <div class="col-md-8">
                                            ...
                                            <input type="hidden" name="edit_categoryimage" value="{{ isset($data) ? $data[0]->category_img : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <a href="{{ url(ADMINURL.'/viewcategory') }}" class="btn btn-danger btn-rounded">Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
