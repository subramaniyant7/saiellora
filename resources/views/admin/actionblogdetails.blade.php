                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap mt-40">
                                <form method="post" action="{{ url(ADMINURL.'/saveblogdetails') }}" enctype='multipart/form-data'>
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-7 col-md-offset-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label mb-10 text-left">Blog Title<span class="help"> *</span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control mb-10" name="blog_title" required
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label mb-10 text-left">Blog Image<span class="help"> *</span></label>
                                                    <div class="col-md-8">
                                                        <input type="file" class="form-control mb-10" name="blog_image" {{ isset($data) && $data[0]->blog_image != '' ? '' : 'required' }}
                                                         value ="{{ isset($action) && $action=='edit' ? $data[0]->blog_image : old('blog_image') }}"  >
                                                         @if(isset($data) && $data[0]->blog_image != '')
                                                         <span><img style="height: 200px;margin-top: 1em;" src="{{ URL::asset('uploads/blog/'.$data[0]->blog_image)}}"></span>
                                                     @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label mb-10 text-left">Blog Description<span class="help"> *</span></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control mb-10" name="blog_description" required
                                            ...
                                            <input type="hidden" name="edit_blogimage" value="{{ isset($data) ? $data[0]->blog_image : '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <a href="{{ url(ADMINURL.'/viewblog') }}" class="btn btn-danger btn-rounded">Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
